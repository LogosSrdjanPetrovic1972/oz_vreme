...
* @copyright    (C)2011 by SSrđan Petrović@edotplus. All rights reserved.
...
*
* @file         pomocugovor.php
* @package       
* @subpackage   
*
* @description  Help informations for contract
*
