...
define('PDF_CHARSET_FROM', 'UTF-8');
define('PDF_CHARSET_TO', 'ISO-8859-2');
...
function FPDF($orientation='P', $unit='mm', $format='A4')
{
	...
	$this->CoreFonts=array('courier'=>'Courier', 'courierB'=>'Courier-Bold', 'courierI'=>'Courier-Oblique', 'courierBI'=>'Courier-BoldOblique',
		...
		'arial'=>'Arial','arialb'=>'Arial-Bold',
		'symbol'=>'Symbol', 'zapfdingbats'=>'ZapfDingbats');
  $this->AddFont('Arial', '', $file='arial.php');
  $this->AddFont('Arial', 'B', $file='arialb.php');
  $this->AddFont('Arial', 'I', $file='ariali.php');
...
function StringConvert($string) {
  $string = @iconv(PDF_CHARSET_FROM, PDF_CHARSET_TO, $string);
	...
	if(!isset($this->fonts[$fontkey]))
	{
		...
		if(isset($this->CoreFonts[$fontkey]))
		{
			if(!isset($fpdf_charwidths[$fontkey]))
			{
				//Load metric file
				$file=$family;
				if($family=='times' || $family=='helvetica' || $family=='arial')
