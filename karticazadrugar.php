...
*
* @file         knjigazadrugar.php
* @package       
* @subpackage   
*
* @description  Choose member for showing member card in the pdf document
*
...
?>
              ...
              <form name="newMember" method="POST" action="./pdfzadrugar.php" target="_blank">
...
?>                      
                    ...
                    &nbsp;
                    <input type="image" src="./images/form/save.jpg" name="submit" alt="Kartica zadrugara" title="Kartica zadrugara" onClick="javascript:return checkMember('Izaberite člana zadruge!');" />
                  </td>
                </tr>
              </table>
              </form>
